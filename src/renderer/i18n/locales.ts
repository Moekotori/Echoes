...
const zhCN: TranslationMap = {
  ...
  'settings.integrations.accounts.cookieFallback': '推荐点击“登录并同步”；手动粘贴 Cookie 作为备用方式。',
  ...
  'settings.integrations.accountPanel.description': '保存平台登录状态，供后续歌词、元数据、MV、下载和流媒体接入使用。',
...
const zhTW: TranslationMap = {
  ...
  'settings.integrations.accounts.cookieFallback': '建議點擊「登入並同步」；手動貼上 Cookie 作為備用方式。',
  ...
  'settings.integrations.accountPanel.description': '儲存平台登入狀態，供後續歌詞、中繼資料、MV、下載和串流媒體接入使用。',
...
const jaJP: TranslationMap = {
  ...
  'settings.integrations.accounts.cookieFallback': '「ログインして同期」を推奨します。Cookie の手動貼り付けは予備手段です。',
  ...
  'settings.integrations.accountPanel.description': '各プラットフォームのログイン状態を保存し、後続の歌詞、メタデータ、MV、ダウンロード、ストリーミング連携で使います。',
...
const enUS: TranslationMap = {
  ...
  'settings.integrations.accounts.cookieFallback': 'Using "Log In And Sync" is recommended; pasting a Cookie manually is the fallback.',
  ...
  'settings.integrations.accountPanel.description': 'Stores platform login state for later lyrics, metadata, MV, downloads, and streaming integrations.',
