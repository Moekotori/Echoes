...
const BAD_MATCH_RE =
  /\b(reaction|cover|remix|rmx|tutorial|lesson|piano|guitar|drum|bass|karaoke|instrumental|nightcore|slowed|reverb|fanmade|dance|practice|live|concert|lyrics?|lyric\s*video|audio|gameplay|walkthrough|playthrough|lets\s*play|gaming|roblox|minecraft|simulator|taxi|driving|race|racing)\b|\u7ffb\u5531|\u7ffb\u5f39|\u94a2\u7434|\u5409\u4ed6|\u67b6\u5b50\u9f13|\u9f13\u624b|\u6559\u7a0b|\u6559\u5b66|\u4f34\u594f|\u5361\u62c9\s*OK|\u7ec3\u4e60|\u642c\u8fd0|\u8f6c\u8f7d|\u73b0\u573a|\u6f14\u5531\u4f1a|\u821e\u8e48|\u7eaf\u97f3\u4e50|\u6e38\u620f|\u624b\u6e38|\u5b9e\u51b5|\u89e3\u8bf4|\u901a\u5173|\u6d4b\u8bc4|\u8d5b\u8f66|\u9a7e\u9a76|\u51fa\u79df\u8f66/i
...
export function analyzeBilibiliAutoMvMatch(video = {}, query = '', context = {}) {
  ...
  const shortOrAmbiguousTitle = trackCompact.length <= 10 || getSignificantTerms(trackTitleNorm).length <= 1
