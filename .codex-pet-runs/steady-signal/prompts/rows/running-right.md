Create one horizontal animation strip for Codex pet `steady-signal`, state `running-right`.
...
Identity: same pet in every frame: A compact whole-body audio stability guardian robot inspired by careful low-risk ECHO engineering: small rounded steel-and-teal body, tiny waveform chest meter, headphones-like side pads, subtle shield-shaped chest plate, calm focused expression, no text, no logos, no scenery, high performance and stability personality. Nickname in Chinese: Wenshengzi.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: polished but quiet 3D toy mascot, readable at 192x208, restrained steel gray, teal, white, and warm amber accents; no purple-blue gradient, no beige theme.
